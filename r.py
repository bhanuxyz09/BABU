...
bot = telebot.TeleBot('7870561205:AAGI_YTAdtS5T_IvompU-mMxGKY2LdREaSE')

# Admin ID
ADMINS = {6240986259}  # Add more admin IDs if needed
OWNER_ID = 6240986259
# Attack settings
nxtlvl_PATH = "./bgmi"
MAX_CONCURRENT_ATTACKS = 5 # Set the maximum number of concurrent attacks
...
REQUIRED_CHANNELS = ["@yetoviphai", "@bhanuxyz09"]  # Add required channels here
...
def handle_attack(message):
    ...
    if not is_user_member(user_id):
        ...
        bot.reply_to(message, 
                   ...
                   f"➡️ [Join Channel 1](https://t.me/yetoviphai)\n"
                   f"➡️ [Join Channel 2](https://t.me/bhanuxyz09)",  parse_mode="Markdown", disable_web_page_preview=True
                )
        return
